...
df_merged =pd.merge(df_output_small, df_input[['mutation_id','sample_id','patient_id','gene','is_driver']], on = ["mutation_id","sample_id"], how="inner")
df_final = df_merged.drop_duplicates(subset=['sample_id', 'gene','cluster_id','is.clonal','is.driver'])
